...
class OnboardingEventsProducer implements ProducerContract
{
     ...
     * @return string
     */
    public static function getOnboardingStartUrl() : string
    {
    ...
    public function handleStart()
    {
        ...
        try {
            ...
            Events::broadcast(new ButtonClickedEvent('godaddy_payments_onboarding_modal_setup_button'));
            ...
            wp_redirect($signupUrl);
            exit;
        } catch (Exception $exception) {
            wp_safe_redirect(admin_url('admin.php?page=wc-settings&tab=checkout&onboardingError=true'));
            exit;
        }
    }
