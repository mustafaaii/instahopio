...
final class OrdersRepositoryTest extends WPTestCase
{
    ...
    /**
     * @covers \GoDaddy\WordPress\MWC\Common\Repositories\WooCommerce\OrdersRepository::getPaidStatuses()
     */
    public function testCanGetPaidStatuses()
    {
        WP_Mock::userFunction('wc_get_is_paid_statuses')->once()->andReturn(['processing', 'completed']);

        $this->assertEquals(['processing', 'completed'], OrdersRepository::getPaidStatuses());
    }
}
