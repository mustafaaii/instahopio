...
class Shop extends AbstractController
{
    ...
    public function getItem()
    {
        ...
        $supportUser = SupportHelper::getSupportUser();
        ...
        $item = [
            'shop' => [
                ...
                'supportBotConnected' => SupportHelper::isSupportBotConnected(),
                ...
                'supportBotConnectUrl' => SupportHelper::getSupportBotConnectUrl(),
