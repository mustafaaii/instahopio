...
{
    /**
     * Test that important configuration values are set in configurations/messages.php.
     *
     * @covers configurations/messages.php
     */
    public function testMessagesConfigurationFile()
    {
        Configuration::initialize([
            StringHelper::trailingSlash(StringHelper::before(__DIR__, 'tests').'configurations'),
        ]);

        $this->assertSame('https://cdn4.mwc.secureserver.net/messages/messages.json', Configuration::get('messages.api.url'));
    }
